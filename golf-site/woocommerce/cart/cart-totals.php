...
<div class="cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">
	...
	<a class="golf-clear-cart" href="#" style="text-decoration: underline;margin-right:10px;">Empty My Shopping Cart</a>
	
	<a class="wc-backward golf-cart-continue" href="<?php echo apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ); ?>"><img style="margin-right:10px;" src="<?php echo get_site_url(); ?>/wp-content/themes/ekornes-child-golf/images/button_continueShopping.png" alt="Continue Shopping"></a>
	
	<a class="checkout-button wc-forward golf-cart-checkout" href="<?php 
